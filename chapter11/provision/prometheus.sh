...
install -m 0644 /vagrant/chapter11/configs/prometheus/prometheus.service /etc/systemd/system/
install -m 0644 -D /vagrant/chapter11/configs/prometheus/prometheus.yml /etc/prometheus/prometheus.yml
install -m 0644 /vagrant/chapter11/configs/prometheus/alerting_rules.yml /etc/prometheus/
...
/vagrant/chapter11/provision/blackbox_exporter.sh
