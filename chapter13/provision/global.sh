...
install -m 0644 -D /vagrant/chapter13/configs/prometheus/global.yml /etc/prometheus/prometheus.yml

systemctl daemon-reload
systemctl enable prometheus
systemctl start prometheus

# Provision thanos query
/vagrant/chapter13/provision/thanos_query.sh
