...
install -m 0644 /vagrant/chapter08/configs/prometheus/prometheus.service /etc/systemd/system/
install -m 0644 -D /vagrant/chapter08/configs/prometheus/prometheus.yml /etc/prometheus/prometheus.yml
install -m 0644 -D /vagrant/chapter08/configs/prometheus/first_rules.yml /etc/prometheus/first_rules.yml
install -m 0644 -D /vagrant/chapter08/configs/prometheus/tests.yml /etc/prometheus/tests.yml
