...
install -m 0644 /vagrant/chapter05/configs/prometheus/prometheus.service /etc/systemd/system/
install -m 0644 -D /vagrant/chapter05/configs/prometheus/prometheus.yml /etc/prometheus/prometheus.yml
