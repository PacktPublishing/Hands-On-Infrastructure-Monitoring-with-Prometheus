...
install -m 0644 /vagrant/chapter09/configs/prometheus/prometheus.service /etc/systemd/system/
install -m 0644 -D /vagrant/chapter09/configs/prometheus/prometheus.yml /etc/prometheus/prometheus.yml
install -m 0644 -D /vagrant/chapter09/configs/prometheus/{alerting,recording}_rules.yml /etc/prometheus/
install -m 0644 -D /vagrant/chapter09/configs/prometheus/tests.yml /etc/prometheus/tests.yml

install -m 0755 /vagrant/chapter09/configs/alertdump/alertdump /usr/bin/
install -m 0644 /vagrant/chapter09/configs/alertdump/alertdump.service /etc/systemd/system/
